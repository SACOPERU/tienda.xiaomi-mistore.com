<x-app-layout>
    ...
    @endpush
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-6 py-2 bg-gray-100  border border-orange-500" id="countdown-container">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <section class="mb-7">
                <div class="flex items-center mb-2">
                    <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-3xl lg:text-4xl dark:text-white"><mark class="px-2 text-orange-500 rounded dark:bg-gray-100">{{$category->name}}</mark></h1>
