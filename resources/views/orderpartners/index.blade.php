<x-app-layout>
    ...
    <div class="container py-12">
        ...
        @if ($orders->count())
            ...
            <ul>
                @foreach ($order_partners as $order_partner )
                    <li>
                        <a href="{{route('orderpartners.show',$order_partner)}}" class="flex items-center py-2 px-4 hover:bg-gray-100">
                            <span class="w-12 text-center">
                                @switch($order_partner->status)
                                    @case(1)
                            ...
                            <span>
                                OrderPartner:{{$order_partner->id}}
                                <br>
                                {{$order_partner->created_at->format('d/m/Y')}}
                            </span>
