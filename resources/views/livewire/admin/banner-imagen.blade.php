                    ...
                    @foreach ($banners as $banner )
                        <tr>
                            <td class="py-2">
                                ...
                                <a href="{{route('admin.banners.show', $banner)}}" class="uppercase underline hover:text-yellow-500">
                                    {{$banner->name}}
                                </a>
                            </td>
                            <td class="py-2">
                                <div class="flex divide-x divide-gray-300 font-semibold">
                                    <a  class="pr-2 hover:text-blue-600 cursor-pointer" wire:click="edit('{{$banner->slug}}')">Editar</a>
                                    <a  class="pl-2 hover:text-red-600 cursor-pointer" wire:click="$emit('deleteBanner', '{{$banner->slug}}')">Eliminar</a>
                                </div>
                            </td>
                        </tr>
