<div>
    <x-jet-form-section submit="save" class="mb-6">
        ...
        <x-slot name="actions">
            <x-jet-action-message class="mr-3" on="saved">
                logotienda Creado correctamente
    ...
    <x-jet-action-section>
        ...
        <x-slot name="description">
            Aqui encontrara todas los logotienda
        </x-slot>
                    ...
                    @foreach ($logo_tiendas as $logo_tienda)
                        <tr>
                            <td class="py-2">
                                ...
                                <a href="{{ route('admin.banners.show', $logo_tienda) }}"
                            ...
                            <td class="py-2">
                                <div class="flex divide-x divide-gray-300 font-semibold">
                                    <a class="pr-2 hover:text-blue-600 cursor-pointer"
                                        wire:click="edit('{{ $logo_tienda->slug }}')">Editar</a>
                                    <a class="pl-2 hover:text-red-600 cursor-pointer"
                                        wire:click="$emit('deleteLogotienda', '{{ $logo_tienda->slug }}')">Eliminar</a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
